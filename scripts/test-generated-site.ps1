...
Assert-True (@($manifest.routes).Count -eq 209) "Expected 209 generated routes."
...
Assert-True (@($docsManifest.articles).Count -eq 10) "Expected ten published documentation articles."
